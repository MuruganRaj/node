...
var query = pool.query('select c.CustomerID, c.ProfileImage from join_group j  join customers c on (j.customer_id=c.CustomerID) where group_id="'+group_id+'"',function(err,rows){
